...
print('{}: ZE_AFFINITY_MASK: {}'.format(
    os.getenv('PMIX_RANK'), os.environ['ZE_AFFINITY_MASK']))
...
print("{}: infile={}".format(os.getenv('PMIX_RANK'),
      lines[int(os.getenv('PMIX_RANK'))]))


strategy = tf.distribute.MirroredStrategy()
print('{}: Number of devices: {}'.format(
    os.getenv('PMIXX_RANK'), strategy.num_replicas_in_sync))
